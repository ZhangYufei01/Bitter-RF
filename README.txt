...
# How to use
Bitter_RF_Main.py is the tool to predict bitter peptides. Users need to confirm the peptide sequences are correctly placed in ./data folder, and input the correct data address in our program.
