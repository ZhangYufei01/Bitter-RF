...
if __name__ == '__main__':
    ...
    parser.add_argument("--method", required=True,
                        choices=['AAC', 'EAAC', 'CKSAAP', 'DPC','ASDC', 'DDE', 'TPC', 'binary',
    ...
    parser.add_argument("--order", dest='order',
                        ...
                        help="output order for of Amino Acid Composition (i.e. AAC, EAAC, CKSAAP, DPC, ASDC, DDE, TPC) descriptors")
    parser.add_argument("--userDefinedOrder", dest='userDefinedOrder',
                        help="user defined output order for of Amino Acid Composition (i.e. AAC, EAAC, CKSAAP, DPC, ASDC, DDE, TPC) descriptors")
